import type { CategoryScore, Group, RequiredElementsResult, ScoreCategory, Submission, Topic } from '@/types';

export type Phase = 'idle' | 'topic' | 'input' | 'grading' | 'reveal' | 'done';
